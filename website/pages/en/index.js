    ...
    const FeatureCallout = () => (
      <div
        ...
        style={{textAlign: 'center'}}>
				<div style={{padding:"30.83% 0 0 0",position:"relative;",width:"990px",margin:"auto"}}><iframe src="https://player.vimeo.com/video/319594227?autoplay=1&title=0&byline=0&portrait=0&muted=1" style={{position:"absolute",top:0,left:0,width:"100%",height:"100%"}} frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
